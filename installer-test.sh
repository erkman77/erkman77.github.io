...
mainmenu() {
  ...
  echo -e "                                         Stand 03.08.2025 settings"
  ...
  echo -e "0) Exit"
  echo -e ""
  echo -e "\e[31ms) Fix Sky Changes 03.08.2025         // fixes channellist, streamrelay, icam, picons" 
...
update_bin() {
  ...
  echo -e " 7) Update Bin Stable  Icam - V11886           ( $_rebootmsg )"
  echo -e " 8) Update Bin Stable  Icam - V11886 Neon      ( $_rebootmsg )"
  echo -e " 9) Update Bin Stable  Icam - V11886 EMU       ( $_rebootmsg )"
  echo -e "10) Update Bin Stable  Icam - V11886 EMU NEON  ( $_rebootmsg )"
  echo -e " 0) Back"
  echo -e ""
